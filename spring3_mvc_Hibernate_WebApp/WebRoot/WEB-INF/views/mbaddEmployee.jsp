...
<html>
	...
	<body>
		...
		<form:form method="POST" action="/sdnext/mbEmployeeController/save.html">
	   		<table>
			    <tr>
	...
	<table align="left" border="1">
		...
		<c:forEach items="${employees}" var="employee">
			<tr>
				...
				<td align="center"><a href="mbEmployeeController/edit.html?id=${employee.id}">Edit</a> | <a href="mbEmployeeController/delete.html?id=${employee.id}">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</c:if>
