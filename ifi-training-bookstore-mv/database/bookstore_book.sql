...
CREATE TABLE `book` (
  ...
  `book_description` varchar(1000) CHARACTER SET utf8 NOT NULL,
  `book_publicYear` int(11) NOT NULL,
...
INSERT INTO `book` VALUES (3,'Book A',10000,'Rat hay',2014,1,1),(5,'22222',1,'22222222',1123,1,1);
...
-- Dump completed on 2014-09-18 17:02:28
